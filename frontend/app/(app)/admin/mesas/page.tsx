            ...
            <section key={m.id} className="card overflow-hidden">
              ...
              <div className="p-4 space-y-3 text-sm">
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex items-end"><button type="button" className="btn-primary w-full" disabled={!m.basecamp_project_id} title="Lee el proyecto Basecamp de la mesa y detecta los boards Daily y Weekly" onClick={async () => {
                    setError(null);
