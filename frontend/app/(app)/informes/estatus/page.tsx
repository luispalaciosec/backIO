      ...
      {cliente && (
        <>
          <div className="flex items-end justify-between gap-4 flex-wrap">
            <div><div className="text-xs uppercase tracking-wide text-gray-500">Control de tareas</div><h2 className="text-xl font-bold">{clienteNombre}</h2><div className="text-sm text-gray-500">Semana del {fecha(desde)} al {fecha(hasta)} · generado {fecha(diaLocal(new Date().toISOString()))}</div></div>
