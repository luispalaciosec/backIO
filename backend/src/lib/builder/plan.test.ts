...
const plantilla: PlantillaArbol = {
  id: 'p', tenant_id: 't', nombre: 'Test', descripcion: null, tipo: 'campana', activa: true, recurrente: false, patron_nombre: null, pilar: null, familia: null, unidad: null, precio_referencia: null, cliente_id: null,
  bloques: [
